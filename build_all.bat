...
:: --- CONFIGURATION ---
set VCPKG_ROOT=D:\sanitary\eshi\vcpkg_installed
set CUDA_PATH=D:\CUDA

:: Compiler Flags
set NVCC_INCLUDES=-I. -I"%VCPKG_ROOT%\x64-windows\include"
set CL_INCLUDES=/I. /I"%VCPKG_ROOT%\x64-windows\include"

:: Linker Libs
set LIBS=/LIBPATH:"%VCPKG_ROOT%\x64-windows\lib" /LIBPATH:"%CUDA_PATH%\lib\x64" SDL2.lib avcodec.lib avformat.lib avutil.lib swscale.lib cudart.lib
...
copy /Y "%VCPKG_ROOT%\x64-windows\bin\*.dll" build\ >nul
